...
class LinearSolver():
    ...
    Methods:
        solve():
            Solves the linear system of equations for the structural analysis problem.
            Removes invalid degrees of freedom (DOF) corresponding to free nodes without elements or stiffness,
            solves the reduced system, and reconstructs the solution vector for all DOFs.
    """
